				...
				<div class="grid grid-cols-1 gap-4 sm:gap-5 md:grid-cols-2 md:gap-6 lg:grid-cols-3">
					...
					>
						<div class="flex flex-col space-y-4">
							...
							<p class="block leading-normal font-light text-gray-50 dark:text-white">
								An online cake shop that I developed in 2024 as my personal project with a focus on
							...
							<div class="flex flex-row space-x-3">
								...
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
										fill="currentColor"
										class="bi bi-github h-4 w-4 md:h-5 md:w-5"
										viewBox="0 0 16 16"
									>
										<path
